...
def simulate_clicker(build_info, duration, strategy):
    ...
    while clicker_state.get_time() <= duration:
        ...
        item_to_buy = strategy(clicker_state.get_cookies(), clicker_state.get_cps(),
                               duration - clicker_state.get_time(), build_info_clone)
        ...
        # Buy the item
        clicker_state.buy_item(item_to_buy, build_info_clone.get_cost(item_to_buy),
